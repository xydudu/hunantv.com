...
JSL = jsl = {
	...
	add: function(a, b) {
		...
		a = jsl.trim(a);
		if (jsl.isLoaded[a] || jsl.inArray(a, jsl.scripts)) return true;
		else if (parseInt(b) < 0 && jsl.isLoaded(a) === false) {
	...
	load: function(a, b) {
		if (typeof a === "undefined" || jsl.trim(a) == "") {
			...
			for (var c = 0; c < jsl.scripts.length; c++) jsl.domAppend(jsl.scripts[c]);
			return true
